...
## Active Technologies
- Python 3.13+ managed by `uv` + watchdog (filesystem events), pathlib (paths) (001-bronze-tier)
- Local filesystem (Obsidian vault markdown + JSON logs) (001-bronze-tier)
- pytest (dev dependency) for unit testing (001-bronze-tier)
